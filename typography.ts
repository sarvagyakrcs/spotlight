  ...
  return {
    ...
    DEFAULT: {
      css: {
        ...
        '--tw-prose-underline': theme('colors.orange.600 / 0.2'),
        ...
        '--tw-prose-code-bg': theme('colors.slate.200 / 0.3'),
        ...
        '--tw-prose-invert-code-bg': theme('colors.slate.800 / 0.3'),
        '--tw-prose-invert-pre-code': theme('colors.slate.100'),
        '--tw-prose-invert-pre-bg': 'rgb(0 0 0 / 0.6)',
        '--tw-prose-invert-pre-border': theme('colors.slate.700 / 0.2'),
